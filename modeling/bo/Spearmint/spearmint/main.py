...
def get_options(cli_args):
    ...
    (commandline_kwargs, args) = parser.parse_args(cli_args)
...
def load_jobs(db, experiment_name):
    ...
    while True:
        try:
            ...
            sys.stderr.write("DB load failed\n")
            continue
